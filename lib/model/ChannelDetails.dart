...
//
//     final channelDetails = channelDetailsFromJson(jsonString);

import 'dart:convert';

ChannelDetails channelDetailsFromJson(String str) =>
    ChannelDetails.fromJson(json.decode(str));

String channelDetailsToJson(ChannelDetails data) => json.encode(data.toJson());
